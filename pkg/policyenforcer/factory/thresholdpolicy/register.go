...
import (
	...
	"github.com/ratify-project/ratify/pkg/policyenforcer/factory"
...
func init() {
	factory.RegisterPolicyEnforcerFactory("threshold-policy", func(opts *factory.NewPolicyEnforcerOptions) (ratify.PolicyEnforcer, error) {
		...
		logrus.Infof("Creating threshold policy enforcer with policy: %+v", policy)
